<template>
    <header class="">
      <div class="bg-gray-900 sm:flex sm:items-center sm:justify-between xl:bg-white">
        ...
        <nav v-show="isOpen">
          <div class="pt-2 pb-4 px-2 border-b border-gray-800">
            <a href="#" class="block px-3 py-1 rounded leading-tight font-semibold text-white hover:bg-gray-800">List your property</a>
            <a href="#" class="block px-3 py-1 rounded leading-tight mt-1 font-semibold text-white hover:bg-gray-800">Trips</a>
            <a href="#" class="block px-3 py-1 rounded leading-tight mt-1 font-semibold text-white hover:bg-gray-800">Messages</a>
          </div>
          <div class="px-5 py-5">
