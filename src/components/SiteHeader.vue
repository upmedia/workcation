<template>
    <header class="sm:flex">
      <div class="w-full bg-gray-900 sm:flex sm:items-center sm:justify-between">
        ...
        <nav class="sm:flex sm:items-center sm:px-4" :class="{ 'hidden': !isOpen, 'block': isOpen}">
          <div class="pt-2 pb-4 px-2 border-b border-gray-800 sm:flex sm:border-0 sm:py-0 sm:px-0">
            ...
            <a href="#" class="block px-3 py-1 rounded leading-tight mt-1 sm:mt-0 font-semibold text-white hover:bg-gray-800 sm:text-sm sm:px-2 sm:ml-2">Trips</a>
            <a href="#" class="block px-3 py-1 rounded leading-tight mt-1 sm:mt-0 font-semibold text-white hover:bg-gray-800 sm:text-sm sm:px-2 sm:ml-2">Messages</a>
          </div>
          <div class="px-5 py-5 sm:py-0 sm:ml-4 sm:px-0">
            ...
            <div class="mt-5 sm:hidden">
              <a href="#" class="block leading-tight text-gray-400 hover:text-white">Account Settings</a>
              <a href="#" class="block leading-tight mt-4 text-gray-400 hover:text-white">Support</a>
              <a href="#" class="block leading-tight mt-4 text-gray-400 hover:text-white">Sign out</a>
            </div>
          </div>
        </nav>
      </div>
